...
<!--<script src="https://cdn.datatables.net/1.10.12/js/jquery.dataTables.min.js"></script>-->
 ...
 <link rel="stylesheet" href="https://cdn.datatables.net/1.10.16/css/dataTables.jqueryui.min.css"/>
    ...
    <body>
        <h4>Student Subject Paper Details</h4>
...
<!--             @if(session('Success'))
            ...
            <div class="additem">
                <a href="{{url('/studentsubjectpaper/create')}}" class='btn btn-info'> <span class="glyphicon glyphicon-plus"></span>Add New </a>
            </div>
        ...
        <div class="table">
          ...
          @foreach($list as $subject_mapping)
               <tbody>
                   <tr>                   
                        <td>{{$subject_mapping['student_subject_paper_mapping_id']}}</td>
                        <td>{{$subject_mapping['type']}}</td>
                        <td>{{$subject_mapping['marks_attained']}}</td>
                        <td>{{$subject_mapping['semester']}}</td>
                        <td>
                           
                            <a href ='{{url("/studentsubjectpaper/{$subject_mapping->student_subject_paper_mapping_id}")}}'> 
        ...
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal">&times;</button>
                    <h4 class="modal-title">Student Subject Mapping Details</h4>
            </div>
            ...
            <div class="modal-footer">
                <form action="{{url('/studentsubjectpaper',$subject_mapping->student_subject_paper_mapping_id)}}" method="POST">

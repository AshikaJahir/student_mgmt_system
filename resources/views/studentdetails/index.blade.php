...
<html lang="{{ app()->getLocale() }}">
    ...
    <body>
        ...
        <div class="container"><br><br>
            ...
            <div class="additem">
                <a href="{{url('/studentdetails/create')}}" class='btn btn-info'> <span class="glyphicon glyphicon-plus"></span>Add New </a>
            </div>
        ...
        <div class="table">
            ...
            @foreach($studentList as $list)   
               <tbody>
                   <tr>                   
                        <td>{{$list['student_details_id']}}</td>
                        <td>{{$list['course_details_id']}}</td>
                        <td>{{$list['user_id']}}</td>
                        <td>{{$list['contact_info']}}</td>
                        <td>{{$list['year_of_joining']}}</td>
                        <td>{{$list['year_of_passout']}}</td>
                        <td>  
                            <a href ='{{url("/studentdetails/{$list->student_details_id}")}}'> 
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <form action="{{url('/studentdetails',$list->student_details_id)}}" method="POST">

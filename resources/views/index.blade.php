        ...
        <div class="sidebar-inner">
          ...
          <div class="sidebar-logo">
            <div class="peers ai-c fxw-nw">
              <div class="peer peer-greed">
                  <a class="sidebar-link td-n" href="adminator/index.html">
                  <div class="peers ai-c fxw-nw">
                    <div class="peer">
                      <div class="logo">
          ...
          <ul class="sidebar-menu scrollable pos-r">
            <li class="nav-item mT-30 active">
                <a class="sidebar-link" href="adminator/index.html">                
            ...
            <li class="nav-item">
                <a class='sidebar-link' href="adminator/email.html">Email old link</a>
                    <a href="{{$_SERVER['REQUEST_URI']}}/email">
                <span class="icon-holder">
            ...
            <li class="nav-item">
                <a class='sidebar-link' href="adminator/compose.html">
                <span class="icon-holder">
            ...
            <li class="nav-item">
                <a class='sidebar-link' href="adminator/calendar.html">
                <span class="icon-holder">
            ...
            <li class="nav-item">
                <a class='sidebar-link' href="adminator/chat.html">
                <span class="icon-holder">
            ...
            <li class="nav-item">
                <a class='sidebar-link' href="adminator/charts.html">
                <span class="icon-holder">
            ...
            <li class="nav-item">
                <a class='sidebar-link' href="adminator/forms.html">
                <span class="icon-holder">
            ...
            <li class="nav-item dropdown">
                <a class="sidebar-link" href="adminator/ui.html">
                <span class="icon-holder">
            ...
            <li class="nav-item dropdown">
              ...
              <ul class="dropdown-menu">
                <li>
                    <a class='sidebar-link' href="adminator/basic-table.html">Basic Table</a>
                </li>
                <li>
                    <a class='sidebar-link' href="adminator/datatable.html">Data Table</a>
                </li>
              </ul>
            </li>
            <li class="nav-item dropdown">
            ...
            <li class="nav-item dropdown">
              ...
              <ul class="dropdown-menu">
                <li>
                    <a class='sidebar-link' href="adminator/blank.html">Blank</a>
                </li>                 
                <li>
                    <a class='sidebar-link' href="adminator/404.html">404</a>
                </li>
                <li>
                    <a class='sidebar-link' href="adminator/500.html">500</a>
                </li>
                <li>
                    <a class='sidebar-link' href="adminator/signin.html">Sign In</a>
                </li>
                <li>
                    <a class='sidebar-link' href="adminator/signup.html">Sign Up</a>
                </li>
              </ul>
            </li>
            <li class="nav-item dropdown">
            ...
            <ul class="nav-right">
              ...
              <li class="notifications dropdown">
                ...
                <ul class="dropdown-menu">
                  ...
                  <li class="pX-20 pY-15 ta-c bdT">
                    <span>
                        <a href="adminator/email.html" class="c-grey-600 cH-blue fsz-sm td-n">View All Email <i class="fs-xs ti-angle-right mL-10"></i></a>
                    </span>
                  </li>
                </ul>
              </li>
              <li class="dropdown">
                ...
                <ul class="dropdown-menu fsz-sm">
                  ...
                  <li>
                      <a href="adminator/email.html" class="d-b td-n pY-5 bgcH-grey-100 c-grey-700">

...
<html lang="{{ app()->getLocale() }}">
    ...
    <body>
        ...
        <div class="container"><br><br>
            ...
            <div class="additem">
                <a href="{{url('/markdetails/create')}}" class='btn btn-info'> <span class="glyphicon glyphicon-plus"></span>Add New </a>
            </div>
            ...
            @foreach($markdetails as $mark)   
               <tbody>
                   <tr>                   
                        ...
                        <td>{{$mark['remarks']}}</td>
                        <td>  
                            <a href ='{{url("/markdetails/{$mark->mark_details_id}")}}'> 
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <form action="{{url('/markdetails',$mark->mark_details_id)}}" method="POST">
